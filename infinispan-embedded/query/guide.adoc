...
* Try link:../query-programmatic-index/guide.html[programmatic index definitions] without annotations
* Use link:../streams/guide.html[distributed streams] for parallel cache processing
