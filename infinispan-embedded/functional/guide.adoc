...
* Try link:../listeners/guide.html[cache listeners] to react to cache changes
* Explore link:../streams/guide.html[distributed streams] for parallel processing
* Use link:../jcache/guide.html[JCache API] for a standard caching interface
