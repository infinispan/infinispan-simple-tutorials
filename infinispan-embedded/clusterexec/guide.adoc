...
* Try link:../cache-distributed/guide.html[distributed caching] for data partitioning across nodes
* Use link:../streams/guide.html[distributed streams] for parallel data processing
* Explore link:../counter/guide.html[clustered counters] for shared state across nodes
