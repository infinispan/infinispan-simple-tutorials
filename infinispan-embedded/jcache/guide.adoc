...
* Try the Infinispan-native API with link:../functional/guide.html[functional maps]
* Add link:../listeners/guide.html[cache listeners] to react to changes
* Explore link:../cache-distributed/guide.html[distributed caching] for clustered setups
