...
* Add link:../security/guide.html[role-based security] to restrict cache access
* Explore link:../cache-distributed/guide.html[distributed caching] for multi-node deployments
