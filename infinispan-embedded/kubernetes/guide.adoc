...
* Try link:../cache-replicated/guide.html[replicated mode] locally before deploying to Kubernetes
* Explore link:../cache-distributed/guide.html[distributed mode] for large datasets where full replication is not feasible
* Add link:../listeners/guide.html[cache listeners] to react to cluster events
