...
* Try link:../cache-distributed/guide.html[distributed mode] where data is partitioned across nodes
* Try link:../cache-replicated/guide.html[replicated mode] where every node has all data
* Add link:../listeners/guide.html[cache listeners] to react to invalidation events
