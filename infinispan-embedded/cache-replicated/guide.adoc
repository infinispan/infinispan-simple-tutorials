...
* Compare with link:../cache-distributed/guide.html[distributed mode] where data is partitioned
* Try link:../cache-invalidated/guide.html[invalidation mode] for locally-managed data
