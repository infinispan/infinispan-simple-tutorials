...
* link:/tutorials/remote-query/[Query your data] with standard Ickle queries
* link:/tutorials/remote-continuous-query/[Use continuous queries] for real-time notifications
