...
public class VectorSearchQuickstart {
   ...
   public static void main(String[] args) throws Exception {
      ...
      RemoteCache<String, Beer> cache = cacheManager.getCache(CACHE_NAME);
      populateBeers(cache);
      System.out.println("Loaded " + cache.size() + " beers.\n");

      fullTextSearch(cache);
      keywordAndRangeFilter(cache);
      projectionsAndSorting(cache);
      knnVectorSearch(cache);
      scoreProjection(cache);
      hybridFilterByStyle(cache);
      hybridFilterByCountry(cache);
      hybridFullTextAndVector(cache);

      TutorialsConnectorHelper.stop(cacheManager);
   }

   private static void populateBeers(RemoteCache<String, Beer> cache) {
   ...
   private static void fullTextSearch(RemoteCache<String, Beer> cache) {
   ...
   private static void keywordAndRangeFilter(RemoteCache<String, Beer> cache) {
   ...
   private static void projectionsAndSorting(RemoteCache<String, Beer> cache) {
   ...
   private static void knnVectorSearch(RemoteCache<String, Beer> cache) {
   ...
   private static void scoreProjection(RemoteCache<String, Beer> cache) {
   ...
   private static void hybridFilterByStyle(RemoteCache<String, Beer> cache) {
   ...
   private static void hybridFilterByCountry(RemoteCache<String, Beer> cache) {
   ...
   private static void hybridFullTextAndVector(RemoteCache<String, Beer> cache) {
