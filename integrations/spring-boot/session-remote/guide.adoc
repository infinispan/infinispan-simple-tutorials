...
* link:../session-embedded/guide.html[Spring Boot embedded sessions] for session storage without a server
* link:../cache-remote/guide.html[Spring Boot remote caching] for data caching with a remote server
