...
* link:/tutorials/integrations-spring-boot-session-remote/[Spring Boot remote sessions] for externalized session storage in an Infinispan Server
* link:/tutorials/integrations-spring-boot-cache-embedded/[Spring Boot embedded caching] for data caching with embedded Infinispan
