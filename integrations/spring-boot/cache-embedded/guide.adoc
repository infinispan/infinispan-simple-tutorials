...
* link:../cache-remote/guide.html[Spring Boot remote caching] for caching with an Infinispan Server
* link:../session-embedded/guide.html[Spring Boot embedded sessions] for HTTP session storage with embedded Infinispan
