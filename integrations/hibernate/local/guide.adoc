...
* link:../spring-local/guide.html[Hibernate L2 cache with Spring Boot] for the same pattern in a Spring Boot application
* link:../wildfly-local/guide.html[Hibernate L2 cache with WildFly] for a Jakarta EE deployment
