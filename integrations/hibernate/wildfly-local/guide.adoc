...
* link:/tutorials/integrations-hibernate-local/[Hibernate L2 cache standalone] for the same pattern without an application server
* link:/tutorials/integrations-hibernate-spring-local/[Hibernate L2 cache with Spring Boot] for a Spring Boot variant
