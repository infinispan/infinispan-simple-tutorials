...
* link:../../../infinispan-ai/vector-search/guide.html[Vector search] for kNN similarity search on embeddings
* link:../../../infinispan-remote/query/guide.html[Remote queries] for Ickle query basics with the Hot Rod client
